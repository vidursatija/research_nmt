...
import os
import random
from train.models import TranslatorModel_E2E #DoubleRNNModel, ModelMode
...
tf.app.flags.DEFINE_string("model_name", "alpha_to_phoneme_notrain", "Model name.")
...
def train():
	...
	m = TranslatorModel_E2E(FLAGS.vocab_size, FLAGS.vocab_size_r, hidden_size=FLAGS.word_size, learn_rate=FLAGS.learn_rate)
