...
import os
import random
from train.models import TranslatorModel_E2E_WW #DoubleRNNModel, ModelMode
...
tf.app.flags.DEFINE_string("model_name", "alpha_to_phoneme_notrain_ww", "Model name.")
...
def train():
	...
	m = TranslatorModel_E2E_WW(FLAGS.vocab_size, FLAGS.vocab_size_r, hidden_size=FLAGS.word_size, learn_rate=FLAGS.learn_rate)
